  ...
  if (cartItems.length === 0) {
    return (
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-24 text-center">
        ...
        <Button 
          asChild
          className="rounded-none px-12 py-6 font-label-caps text-label-caps uppercase tracking-widest hover:bg-tertiary-fixed-dim hover:text-primary transition-colors"
        >
          <Link href="/collections/watches">Continue Shopping</Link>
        </Button>
      </div>
    );
  }
      ...
      <div className="lg:col-span-4 relative">
        <div className="md:sticky top-32 bg-surface-container-low p-8 rounded-DEFAULT">
          ...
          <Button 
            ...
            className="w-full rounded-none py-6 font-label-caps text-label-caps uppercase tracking-widest flex justify-center items-center gap-2 transition-colors"
          >
            Proceed to Checkout
