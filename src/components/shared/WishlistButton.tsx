  ...
  if (withText) {
    return (
      <Button 
        ...
        disabled={isPending}
        className={cn(
          "w-full bg-transparent font-label-caps text-label-caps uppercase py-6 border transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-70 rounded-none",
          isWishlisted 
